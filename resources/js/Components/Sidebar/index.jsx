...
const Sidebar = () => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`z-[50] fixed   left-0 h-full flex  w-72.5 flex-col overflow-hidden bg-[#f7f8f9] duration-300 ease-linear   `}
    >
      <div className="no-scrollbar  flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="  py-4  mt-5  ">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-3 px-6  text-xl font-semibold text-primaryColor ">
              MENU
            </h3>
            ...
            <div className="space-y-2">
              ...
              <div className="flex  items-center px-6 text gap-x-2 cursor-pointer hover:text-primaryColor  ">
                <svg
                  className="size-4 fill-primaryColor"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
