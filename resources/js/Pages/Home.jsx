      ...
      <div className="w-full flex flex-col gap-y-4">
        <div className="">
            ...
            <div class="flex px-4 ">
                    <div class="w-2/3">
                        <ul>
                            <li className="flex gap-x-1 items-center font-bold text-[#323338] py-4"><span className="cursor-pointer" onClick={handleOpen}>{!isOpen ? <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="#323338" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>: <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 " viewBox="0 0 512 512"><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>}</span>Recently Created</li>
                            <div className="grid grid-cols-2 gap-4">
            {isOpen &&
                projects.slice(0, 4).map((project, index) => (
                    <div key={index} className="p-2 border-2 rounded-md border-gray ml-6">
                            ...
                            <div className="flex items-center gap-x-2">
                                <div className="w-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path fill="#666778" d="M0 96C0 60.7 28.7 32 64 32l384 0c35.3 0 64 28.7 64 64l0 320c0 35.3-28.7 64-64 64L64 480c-35.3 0-64-28.7-64-64L0 96zm64 64l0 256 160 0 0-256L64 160zm384 0l-160 0 0 256 160 0 0-256z"/>
                                    </svg>
                                </div>
            ...
            {(projects.length > 4 && isOpen) && (
                ...
                <li className="flex gap-x-1 items-center font-bold text-[#323338]"><span className="cursor-pointer" onClick={handleUpdateFeed}>{!isUpdateFeed ? <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="#323338" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>: <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 " viewBox="0 0 512 512"><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>}</span>Update Feed (inbox) <span className="bg-blue-500 rounded-full px-1 text-white" >0</span></li>
                        {
            isUpdateFeed &&
                    <div>
                            <div>this is the update feed </div>
                    </div>
                    }
