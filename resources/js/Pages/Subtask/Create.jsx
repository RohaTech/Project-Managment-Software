...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Create SubTask</h2>}
        >
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                />
                                {errors.task_id && <div className="text-red-500 text-xs mt-1">{errors.task_id}</div>}
                            </div>
