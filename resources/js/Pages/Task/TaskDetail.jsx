      ...
      <div className=" mx-auto  overflow-hidden overflow-y-hidden h-[100%] ">
        <div className="sticky-task-name-bar fixed">
          ...
          <div className="">
            ...
            {/* Due Date */}
            <div className="flex gap-6 items-center py-2">
              <strong className="font-black text-gray-700">Due Date:</strong>
              <span className="text-gray-900">
            ...
            {/* Status */}
            <div className="flex gap-6 items-center py-2">
              <strong className="font-black text-gray-700">Status:</strong>
              <span
                ...
                {!showEditForm ? (
                  <div className="w-[85%]">
                    <p className="text-sm text-gray-800">
                      ...
                      {descriptionExceedsLimit && !showMore
                  ...
                  >
                    <textarea
                      ...
                      id="description"
                      onChange={(e) =>
                        setTaskData("description", e.target.value)
                      }
