...
export default function ProjectCopy() {
  ...
  const mappedProjects = projects.map((project, index) => (
    <div
      ...
      key={index}
      className="relative justify-center cursor-pointer min-h-[170px] flex flex-col group my-4 bg-white shadow-sm border border-slate-200 rounded-lg group w-96 hover:shadow-lg duration-700 ease-linear hover:shadow-gray-400"
    >
      <div className="p-4">
