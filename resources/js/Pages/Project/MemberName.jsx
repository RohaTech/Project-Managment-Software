...
const MemberName = ({ members, setData, task, handleAssignedSubmit }) => {
  const initialAssignedMember = members.find(
    (member) => member.id === task.assigned
  );
    ...
    <Menu as="div" className="relative inline-block text-left w-full">
      <div>
        ...
        <MenuButton className="inline-flex w-full justify-between items-center border rounded-md px-4 py-2 bg-white text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
          {selectedMember ? (
            <span>
              <span className="text-white text-xs p-[6px] rounded-full font-bold bg-green-500 mr-2">
            ...
            >
              ...
              <circle
                ...
                cy="13.546"
                r="8.046"
                fill="url(#SVGID_1__ScJCfhkd77yD_gr1)"
              ></circle>
              <linearGradient
                id="SVGID_00000139257311853942507350000017824593529916478390__ScJCfhkd77yD_gr2"
                x1="32.211"
                x2="15.789"
                y1="25.899"
                y2="42.321"
              ...
              <path
                fill="url(#SVGID_00000139257311853942507350000017824593529916478390__ScJCfhkd77yD_gr2)"
                d="M34.228,29.5H13.772	c-2.152,0-3.896,1.791-3.896,4c0,12,28.248,12,28.248,0h0.001C38.125,31.291,36.38,29.5,34.228,29.5z"
              ></path>
              <path
                fill="none"
                stroke="#2e9bfe"
                ...
                stroke-miterlimit="5"
                stroke-width="3"
                d="M21.388,5.909C22.211,5.643,23.089,5.5,24,5.5c4.694,0,8.5,3.806,8.5,8.5s-3.806,8.5-8.5,8.5	s-8.5-3.806-8.5-8.5"
              ></path>
              <path
                fill="none"
                stroke="#2e9bfe"
                ...
                stroke-width="3"
                d="M32.191,29.5h2.31c2.209,0,4,1.791,4,4v0H38.5c0,12-29,12-29,0v0c0-2.209,1.791-4,4-4h11.798"
              ></path>
            </svg>
          )}{" "}
          {/* First name */} {selectedMember ? "" : <span>Assign</span>}
          <svg
