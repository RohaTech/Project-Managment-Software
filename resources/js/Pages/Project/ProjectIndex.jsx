    ...
    <AuthenticatedLayout>
      <div className="rounded-sm border border-stroke bg-white cursor-pointer  pt-6   shadow-default   px-7 pb-1">
        ...
        <div className="flex flex-col">
          <div className="grid grid-cols-5 p-5 font-semibold text-primary  uppercase  rounded-sm bg-[#f7f9fc] ">
            <div className=" ml-8 ">
          ...
          {projects.map((project, key) => (
            <Link href={route("project.show", project.id)} className="block">
              <div
                className={`grid grid-cols-5 hover:bg-gray-200 group  ${
              ...
              >
                ...
                <div className="flex items-center justify-center col-span-2   p-2.5 xl:p-5">
                  <p className="">
                    {project.description
                      ? project.description
                      : "NO Description"}
