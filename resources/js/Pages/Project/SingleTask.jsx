...
data.status === "In Progress" && isDatePassed(data.due_date) ? (<div><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
<path fill="#f44336" d="M44,24c0,11.044-8.956,20-20,20S4,35.044,4,24S12.956,4,24,4S44,12.956,44,24z"></path><path fill="#ffebee" d="M22 10h4v21h-4V10zM22 34h4v4h-4V34z"></path>
</svg></div>) : (
    <div>
      ...
      {isEditing ? (
        ...
        <input
          ...
          className={`border-0 text-center w-36 cursor-pointer ${data.status==="Completed"? 'line-through': ''}`}
        />
      )}
      </td>
