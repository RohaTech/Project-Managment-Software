      ...
      <td className="border border-slate-300 border-collapse text-center cursor-pointer flex items-center">
        {data.status === "Completed" ? (
          <div>
            ...
            >
              <linearGradient
                id="FR_9NzDz28iTOUpGSsOFAa_91kLZWvmd4sg_gr1"
                x1="10.043"
                x2="38.307"
                y1="10.241"
                y2="38.504"
              ...
              <path
                fill="url(#FR_9NzDz28iTOUpGSsOFAa_91kLZWvmd4sg_gr1)"
          ...
          <div>
            ...
            >
              ...
              <path
                fill="#ffebee"
                d="M22 10h4v21h-4V10zM22 34h4v4h-4V34z"
              ></path>
            </svg>
          </div>
          ...
          <div>
            ...
            >
              <path
                fill="#3949AB"
                d="M32.615 12.257H36.615V17.256999999999998H32.615z"
                transform="rotate(38.956 34.616 14.757)"
              ></path>
              <path fill="#3949AB" d="M21 9H27V13H21z"></path>
              <path
                fill="#EEE"
                d="M24 14.5A13.5 13.5 0 1 0 24 41.5A13.5 13.5 0 1 0 24 14.5Z"
              ></path>
              <path
                fill="#263238"
                d="M22.634,30.118c1.173,0.763,2.741,0.422,3.492-0.765c0.754-1.186,0.412-2.762-0.764-3.529c-1.176-0.761-2.736-0.417-3.493,0.773C21.116,27.782,21.456,29.361,22.634,30.118"
              ></path>
              <path
                fill="#263238"
                d="M14.778 22L24.199 26.084 22.38 28.943z"
              ></path>
              <path
                fill="#9FA8DA"
                d="M23.545,28.691c0.392,0.251,0.913,0.137,1.161-0.261c0.252-0.393,0.139-0.92-0.255-1.171c-0.388-0.256-0.913-0.14-1.165,0.254C23.036,27.909,23.15,28.438,23.545,28.691"
              ></path>
              <g>
                <path
                  fill="#90A4AE"
              ...
              <g>
                <path
                  fill="#7986CB"
                  d="M37.891 15.477c-.347.43-.977.497-1.406.149l-3.11-2.515c-.43-.348-.496-.977-.149-1.406l1.887-2.333c.348-.431.977-.497 1.406-.149l3.11 2.515c.43.348.497.977.149 1.406L37.891 15.477zM24 12c-8.835 0-16 7.165-16 16s7.165 16 16 16 16-7.165 16-16S32.835 12 24 12zM24 41c-7.181 0-13-5.819-13-13 0-7.18 5.819-13 13-13s13 5.82 13 13C37 35.181 31.181 41 24 41zM29 9c0 .553-.447 1-1 1h-8c-.553 0-1-.447-1-1V5c0-.553.447-1 1-1h8c.553 0 1 .447 1 1V9z"
                ></path>
              </g>
            </svg>
          </div>
